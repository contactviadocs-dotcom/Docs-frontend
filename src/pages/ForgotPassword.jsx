...
export default function ForgotPassword() {
  ...
  const handleSendOtp = async (e) => {
    ...
    setLoading(true);
    try {
      const res = await fetch("https://doc-backend-h9aw.onrender.com//api/auth/send-otp", {
        method: "POST",
  ...
  const handleVerifyOtp = async (e) => {
    ...
    setLoading(true);
    try {
      const res = await fetch("https://doc-backend-h9aw.onrender.com//api/auth/verify-otp", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const handleResetPassword = async (e) => {
    ...
    setLoading(true);
    try {
      const res = await fetch("https://doc-backend-h9aw.onrender.com//api/auth/reset-password", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
