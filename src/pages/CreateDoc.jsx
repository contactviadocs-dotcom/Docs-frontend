  ...
  const delayDebounce = setTimeout(async () => {
    ...
    try {
      const res = await axios.post(
        "https://doc-backend-h9aw.onrender.com//api/docs/check-name",
...
useEffect(() => {
  ...
  const loadDocument = async (docId) => {
    try {
      const response = await fetch(`https://doc-backend-h9aw.onrender.com//api/docs/my-docs/${docId}`, {
...
const handleRename = async (e) => {
  ...
  try {
    ...
    const res = await fetch("https://doc-backend-h9aw.onrender.com//api/docs/my-docs", {
      headers: { Authorization: `Bearer ${token}` },
    });
    ...
    const updateRes = await fetch(`https://doc-backend-h9aw.onrender.com//api/docs/my-docs/${docId}`, {
      method: "PUT",
      headers: {
  ...
  try {
    ...
    // Create new doc
    const response = await fetch("https://doc-backend-h9aw.onrender.com//api/docs/my-docs", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${token}`,
  ...
  const toggleFavorite = async () => {
    ...
    try {
      const response = await fetch(`https://doc-backend-h9aw.onrender.com//api/docs/my-docs/${docId}/favorite`, {
        method: 'PATCH',
        headers: { Authorization: `Bearer ${token}` }
      });
...
const deleteDocument = async () => {
  try {
    await axios.delete(`https://doc-backend-h9aw.onrender.com//api/docs/my-docs/${docId}`, {
      headers: { Authorization: `Bearer ${token}` },
    });
...
const handleImageUpload = async (event) => {
  ...
  try {
    const token = localStorage.getItem("token");
    const response = await fetch("https://doc-backend-h9aw.onrender.com//api/docs/upload-image", {
      method: "POST",
      headers: {
        Authorization: `Bearer ${token}`,
      },
